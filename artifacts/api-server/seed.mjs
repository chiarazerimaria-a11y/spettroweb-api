...
const MACHINES = [{"name":"SRV","slug":"srv","os":"Linux","difficulty":"dificil","characterType":"virus","points":20,"description":"","vulnerability":"","techniques":"","hints":null,"downloadUrl":"https://drive.proton.me/urls/6P6YTHXGN4#7P8tpZ9l0R6J","writeupUrl":null,"videoUrl":"https://www.youtube.com/watch?v=JTiNkerObRs","solveCount":0,"isActive":true},{"name":"Hel","slug":"hel","os":"Linux","difficulty":"dificil","characterType":"skull","points":40,"description":"La diosa del inframundo. Mitad viva, mitad muerta. Dual boot.","vulnerability":"Dual Boot Exploit → Cross-OS → Root","techniques":"Buffer Overflow,Pivoting,BloodHound,Cross-Platform Exploit","hints":"La mitad viva de la máquina oculta la mitad muerta.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":71,"isActive":true},{"name":"Valkyrie","slug":"valkyrie","os":"Linux","difficulty":"dificil","characterType":"ninja","points":40,"description":"Ella elige quién vive. Bypass de mecanismos de seguridad avanzados.","vulnerability":"Security Bypass → Privilege Selection → Root","techniques":"Buffer Overflow,Pivoting,BloodHound,CrackMapExec","hints":"Las valquirias dejan rastros en el campo de batalla.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":88,"isActive":true},{"name":"Hephaestus","slug":"hephaestus","os":"Linux","difficulty":"medio","characterType":"robot","points":30,"description":"El herrero divino. Servicios industriales mal configurados.","vulnerability":"Exposed Admin Panel → RCE → Root","techniques":"Burp Suite,SQLi,LFI,LinPEAS,Hydra","hints":"El herrero tiene sus herramientas expuestas en el panel.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":198,"isActive":true},{"name":"Shellshock","slug":"shellshock","os":"Linux","difficulty":"facil","characterType":"robot","points":20,"description":"La vulnerabilidad clásica de Bash. CGI scripts vulnerables.","vulnerability":"Shellshock CVE-2014-6271 → RCE","techniques":"Nmap,Curl,Bash Exploit,Netcat","hints":"El bug está en cómo Bash procesa variables de entorno.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":312,"isActive":true},{"name":"Pandora","slug":"pandora","os":"Linux","difficulty":"facil","characterType":"ghost","points":20,"description":"La caja que no debías abrir. Servicios web mal configurados.","vulnerability":"SNMP Enumeration → SSH Tunnel → LFI → Root","techniques":"SNMPwalk,SSH Tunneling,LFI,Cron Exploit","hints":"A veces los servicios ocultos hablan si les preguntas bien.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":445,"isActive":true},{"name":"Nibbles","slug":"nibbles","os":"Linux","difficulty":"facil","characterType":"ninja","points":20,"description":"Pequeña pero peligrosa. Panel de administración expuesto.","vulnerability":"NibbleBlog Arbitrary File Upload → RCE","techniques":"Gobuster,Burp Suite,File Upload Bypass,Sudo Exploit","hints":"Busca el panel de admin. Está escondido pero no tanto.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":501,"isActive":true},{"name":"Lame","slug":"lame","os":"Linux","difficulty":"facil","characterType":"demon","points":20,"description":"La primera máquina que todo hacker debe comprometer. Clásico absoluto.","vulnerability":"Samba 3.0.20 CVE-2007-2447 → Root","techniques":"Nmap,Metasploit,Manual Exploit","hints":"Samba tiene una vulnerabilidad conocida en esta versión.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":678,"isActive":true},{"name":"Blue","slug":"blue","os":"Windows","difficulty":"facil","characterType":"skull","points":20,"description":"EternalBlue. El exploit que cambió el mundo del hacking.","vulnerability":"MS17-010 EternalBlue → SYSTEM","techniques":"Nmap,Metasploit,Manual MS17-010","hints":"WannaCry te dejó pistas. El nombre lo dice todo.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":589,"isActive":true},{"name":"Jerry","slug":"jerry","os":"Windows","difficulty":"facil","characterType":"robot","points":20,"description":"Apache Tomcat mal configurado. Credenciales por defecto.","vulnerability":"Tomcat Default Creds → WAR Upload → SYSTEM","techniques":"Gobuster,WAR Shell,Tomcat Manager","hints":"Manager/manager. El admin nunca cambió la contraseña.","downloadUrl":null,"writeupUrl":null,"videoUrl":null,"solveCount":423,"isActive":true}];
...
// Demo marketplace products — always seeded so the marketplace is never empty after deployment
// seller_username references are platform curators (chiara=id1, chiareta=id2)
const MARKETPLACE_PRODUCTS = [
  {
    title: 'Writeup Completo — HTB Forest (Active Directory)',
    description: 'Resolución paso a paso de Forest (HackTheBox). AS-REP Roasting, BloodHound, DCSync y escalada a Domain Admin. Incluye comandos y capturas.',
    category: 'writeup',
    price: 150,
    sellerUsername: 'chiara',
    downloadUrl: 'https://github.com/chiara-spettro',
    thumbnailUrl: 'https://www.hackthebox.com/storage/avatars/23a6cdb39e80cdd2a7d0f1e7a04a7f12.png',
    rating: 4.9,
    salesCount: 47,
  },
  {
    title: 'AutoRecon Pro — Script de Enumeración Avanzada',
    description: 'Script Python que automatiza reconocimiento: nmap, gobuster, nikto, ffuf y whatweb en una sola ejecución. Genera reporte HTML.',
    category: 'script',
    price: 250,
    sellerUsername: 'chiara',
    downloadUrl: 'https://github.com/chiara-spettro',
    thumbnailUrl: 'https://images.unsplash.com/photo-1629654297299-c8506221ca97?w=400&q=80',
    rating: 4.8,
    salesCount: 83,
  },
  {
    title: 'Cheatsheet Completo — Privilege Escalation Linux',
    description: 'Apuntes definitivos de escalada en Linux: SUID, cron jobs, capabilities, PATH injection, sudo abuse y más. Formato PDF + Markdown.',
    category: 'notes',
    price: 100,
    sellerUsername: 'chiara',
    downloadUrl: 'https://github.com/chiara-spettro',
  ...
  {
    title: 'Guía Práctica — Bug Bounty Web desde Cero',
    description: 'Metodología completa para bug bounty: recon, subdomain enum, XSS, SQLi, SSRF, IDOR y cómo reportar. Casos reales resueltos.',
    category: 'course',
    price: 500,
    sellerUsername: 'chiara',
    downloadUrl: 'https://github.com/chiara-spettro',
  ...
  {
    title: 'Writeup — THM RootMe (Principiantes)',
    description: 'Writeup de la sala RootMe de TryHackMe. Enumeración web, upload bypass, reverse shell y escalada SUID. Ideal para empezar.',
    category: 'writeup',
    price: 50,
    sellerUsername: 'chiareta',
    downloadUrl: 'https://github.com',
    thumbnailUrl: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=400&q=80',
    rating: 4.6,
    salesCount: 89,
  },
  {
    title: 'SQLMap Tamper Pack — 15 Scripts Bypass WAF',
    description: 'Colección de 15 scripts tamper para SQLMap que evaden WAFs comunes (CloudFlare, ModSecurity, AWS WAF). Probados en entornos reales.',
    category: 'tool',
    price: 300,
    sellerUsername: 'chiareta',
    downloadUrl: 'https://github.com',
  ...
  {
    title: 'Apuntes OSCP — Buffer Overflow 32-bit',
    description: 'Notas detalladas sobre Buffer Overflow para el OSCP: spiking, fuzzing, offset, badchars, shellcode. Plantillas de exploit incluidas.',
    category: 'notes',
    price: 200,
    sellerUsername: 'chiara',
    downloadUrl: 'https://github.com/chiara-spettro',
...
async function seed() {
  ...
  if (!dbUrl) { console.log('[seed] No DATABASE_URL, skipping.'); return; }
  const client = new Client({ connectionString: dbUrl });
  await client.connect();
  try {
    // ── Courses: UPSERT only — never delete admin-added courses ──────────────
    ...
    console.log('[seed] Courses done:', COURSES.length);
    ...
    for (let i = 0; i < MACHINES.length; i++) {
      ...
      await client.query(
        ...
        [m.name,m.slug,m.os,m.difficulty,m.characterType,m.points,m.description,m.vulnerability,m.techniques,m.hints,m.downloadUrl,thumbUrl,m.solveCount,m.isActive]
      );
    }
    console.log('[seed] Machines done:', MACHINES.length);
    ...
    for (const [name,slug,captain,desc,emblem,members,points,level,wins,losses,status,isBot,aiDiff] of SQUADS) {
      await client.query(
        ...
        [name,slug,captain,desc,emblem,members,points,level,wins,losses,status,isBot,aiDiff]
      );
    }
    console.log('[seed] Squads done:', SQUADS.length);

    // ── CTF Missions: INSERT only — never delete admin-added missions ────────
    for (const [name,desc,diff,ip,pts,flag] of MISSIONS) {
      ...
      if (ex.rows.length === 0) {
        await client.query(
          ...
          [name,desc,diff,ip,pts,flag]
        );
      }
    }
    console.log('[seed] Missions done:', MISSIONS.length);

    // ── Tutoring sessions (platform curator sessions) ────────────────────────
    const tutorRow = await client.query('SELECT id FROM users ORDER BY id LIMIT 1');
    const tutorId = tutorRow.rows[0]?.id ?? 1;
    const existingTitles = await client.query('SELECT title FROM tutoring_sessions WHERE tutor_username=$1', ['chiara ia']);
    const existingTutorTitles = new Set(existingTitles.rows.map(r => r.title));
    for (const [title, desc, dur, price, link] of TUTORING) {
      if (!existingTutorTitles.has(title)) {
        await client.query(
    ...
    console.log('[seed] Tutoring done:', TUTORING.length);

    // ── Marketplace products: INSERT if not exists by title ──────────────────
    // Look up seller IDs by username (users seeded at registration, not here)
    const usersRes = await client.query("SELECT id, username FROM users WHERE username IN ('chiara','chiareta')");
    const userMap = {};
    for (const row of usersRes.rows) userMap[row.username] = row.id;

    let mpCount = 0;
    for (const p of MARKETPLACE_PRODUCTS) {
      const sellerId = userMap[p.sellerUsername];
      if (!sellerId) continue; // seller doesn't exist yet, skip
    ...
    console.log('[seed] Marketplace products done (inserted):', mpCount, '/', MARKETPLACE_PRODUCTS.length);
    ...
    console.log('[seed] Certifications done:', CERTIFICATIONS.length);

    // ── Live Streams: INSERT demo sessions if table is empty ─────────────────
    const streamsCount = await client.query('SELECT COUNT(*) FROM live_streams');
    if (parseInt(streamsCount.rows[0].count) === 0) {
      const now = new Date();
      const STREAMS = [
      ...
      for (const [title,instructor,desc,scheduledAt,dur,maxP,type,price,roomUrl,status] of STREAMS) {
        await client.query(
          ...
          [title,instructor,desc,scheduledAt,dur,maxP,type,price,roomUrl,status]
        );
      }
      console.log('[seed] Live streams seeded: 4');
    } else {
      console.log('[seed] Live streams already exist, skipping');
    }

    // ── Admin password reset (keeps chiara able to log in after fresh deploy) ─
    await client.query(
      "UPDATE users SET password_hash=$1 WHERE username='chiara'",
      ['$2b$12$6ecRAPi.re5u8nVo79X4y.OQzfi.auEByX5tt80qXBUNoQpqxFiIa']
    );
    console.log('[seed] Password reset done');
